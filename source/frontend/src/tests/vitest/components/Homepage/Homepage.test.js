...
describe('Homepage', () => {
    ...
    it('should have import button on home page in self managed mode', async () => {
        ...
        screen.getByText(/get started by importing regions from one or more of your accounts\./i);
    ...
    it('should not have import button on home page in organizations mode', async () => {
        ...
        const importText = screen.queryByText(/get started by importing regions from one or more of your accounts\./i);
