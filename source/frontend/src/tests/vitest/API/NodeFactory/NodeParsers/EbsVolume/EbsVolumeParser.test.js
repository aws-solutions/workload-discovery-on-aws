    ...
    test('it should parse EBS volume in use', () => {
        const node = {
            ...
            "properties": {
                ...
                "configuration": "{\"volumeType\":\"gp2\",\"volumeId\":\"vol-1234567890abcdef\",\"key2\":\"prop2\",\"state\":{\"value\":\"in-use\"}}",
    ...
    test('it should parse EBS volume in failed state', () => {
        const node = {
            ...
            "properties": {
                ...
                "configuration": "{\"volumeType\":\"gp2\",\"volumeId\":\"vol-1234567890abcdef\",\"key2\":\"prop2\",\"state\":{\"value\":\"failed\"}}",
                "supplementaryConfiguration": {}
            }
        };
