...
import AccountImportStackSetsForm from './AccountImportStackSetsForm';
import StackSetsWarning from './StackSetsWarning'
  ...
  return (
    <>
      ...
      <SpaceBetween direction='vertical' size='l'>
          <SpaceBetween direction='vertical' size='l'>
            <StackSetsWarning />
            <AccountImportStackSetsForm addRegions={addRegions} importedRegions={importedRegions}/>
          </SpaceBetween>
