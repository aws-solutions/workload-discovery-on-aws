...
import AccountImportBody from './AccountImportBody';
import AccountImportDownload from './AccountImportDownload';
import AccountImportDeploy from './AccountImportDeploy';
...
const AccountImportWizard = ({ reloadTable }) => {
  ...
  return (
    <Wizard
      ...
      steps={[
        ...
        {
          title: 'Deploy AWS CloudFormation templates',
          description:
            'Deploy the AWS CloudFormation templates to set up a small amount of infrastructure to allow AWS Perspective to discover resources in the AWS Regions shown below',
          content: (
            <AccountImportDeploy
...
AccountImportWizard.propTypes = {
  reloadTable: PropTypes.func.isRequired,
};

export default AccountImportWizard;
