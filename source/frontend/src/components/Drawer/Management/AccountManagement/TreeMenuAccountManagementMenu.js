...
import ImportDialog from './Account/ImportDialog';
    ...
    <>
      <RootRef rootRef={treeViewRef}>
        <TreeView
          ...
          <Tooltip placement='right-end' title="Manage discoverable Accounts & Regions">
            <TreeItem
              key='0'
              nodeId='0'
      ...
      {importDialog && <ImportDialog toggleImportModal={toggleDialog} />}
    </>
  );
};
