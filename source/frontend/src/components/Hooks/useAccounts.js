  ...
  const mutation = useMutation((accounts) => wrapRequest(processAccountsError, addAccounts, {
    ...
    onSuccess: async () => {
      ...
      addNotification({
        ...
        content: "The specified accounts and regions have been successfully imported",
        type: "success"
      })
      window.scrollTo(0, 0)
    },
  ...
  const mutation = useMutation((accountIds) => wrapRequest(processAccountsError, deleteAccounts, {
    ...
    onSuccess: async () => {
      ...
      addNotification({
        ...
        content: "The specified accounts have been successfully removed",
        type: "success"
      })
      window.scrollTo(0, 0)
    },
  ...
  const mutation = useMutation(({accountId, regions}) =>  wrapRequest(processAccountsError, deleteRegions, {
    ...
    onSuccess: async () => {
      ...
      addNotification({
        ...
        content: "The specified account regions have been successfully removed",
        type: "success"
      })
      window.scrollTo(0, 0)
    },
...
const invalidateQueries = (queryClient) => Promise.all([
