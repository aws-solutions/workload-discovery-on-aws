                        ...
                        <div className="header-title">
                            ...
                            <Box variant="p" fontWeight="light">
                                <span className="header-sub-title">
                                    Workload Discovery on AWS is a tool to
                                    visualize AWS Cloud workloads. Use Workload
                                    Discovery on AWS to build, customize, and
                                    share detailed architecture diagrams of your
                                    workloads based on live data from AWS.
                                </span>
                            </Box>
                        </div>
                        {isUsingOrganizations() ? (
                                ...
                                <Container>
                                    <SpaceBetween size="xl">
                                        ...
                                        <Box variant="p" padding="n">
                                            Get started by importing regions
                            ...
                            <Container>
                                <ColumnLayout columns={2} variant="text-grid">
                                    <div>
                                        ...
                                        <Box variant="p">
                                            Workload Discovery on AWS lets you
                                            build, customize, and share detailed
                                            architecture diagrams. Workload
                                            Discovery on AWS maintains an
                                            inventory of the AWS resources
                                            across your accounts and Regions,
                                            mapping relationships between them,
                                            and displaying them in a web UI.
                                        </Box>
                                    </div>
                                    <div>
                                        <Box variant="h3" padding={{top: 'n'}}>
                                            Query AWS Cost & Usage Reports
                                            (CURs)
                                        </Box>
                                        <Box variant="p">
                                            The cost query builder lets you
                                            locate AWS resources and services
                                            that may have incurred a cost. The
                                            estimated cost data is automatically
                                            calculated for the time period
                                            specified and displays on your
                                            architecture diagrams. You can
                                            generate a cost report for your
                                            architecture diagrams that contains
                                            an overview of the estimated cost
                                    ...
                                    <div>
                                        ...
                                        <Box variant="p">
                                            The search feature lets you use
                                            basic information, such as resource
                                            name, Tag name, or IP address to
                                            locate the resources you are
                                            interested in.
                                        </Box>
                                    </div>
                                    <div>
                                        ...
                                        <Box variant="p">
                                            Explore resources provisioned across
                                            your accounts and Regions using the
                                            resource directory. It contains all
                                            the resources Workload Discovery on
                                            AWS has discovered. You can start
                                            building your Workload Discovery on
                                            AWS architecture diagrams by
                                            selecting a resource in the web UI.
                                        </Box>
                                    </div>
                                </ColumnLayout>
                            </Container>
