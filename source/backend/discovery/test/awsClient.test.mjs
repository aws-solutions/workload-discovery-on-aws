...
import {ListSubscriptionsCommand, SNSClient} from '@aws-sdk/client-sns';
...
describe('awsClient', () => {
    ...
    describe('throttledPaginator', () => {
        ...
        it('should handle one page', async () => {
            ...
            const results = [];
            for await (const x of throttledPaginator(
                throttler,
                asyncGenerator
            )) {
                results.push(x);
    ...
    describe('apiGatewayClient', () => {
        const {getAuthorizers, getMethod, getResources} =
        ...
        describe('getAuthorizers', () => {
            ...
            it('should get resources', async () => {
                ...
                const resources = {
                    restApiId: {
                        items: [{id: 'resourceId1'}, {id: 'resourceId2'}],
                        position: 'restApiId-position',
                    },
                    'restApiId-position': {
                        items: [{id: 'resourceId3'}, {id: 'resourceId4'}],
                    },
                };
    ...
    describe('serviceCatalogAppRegistryClient', () => {
        const {getAllApplications} =
            awsClient.createServiceCatalogAppRegistryClient(
                mockCredentials,
                EU_WEST_1
            );
        ...
        describe('getAllApplications', () => {
            it('should return hydrated applications list', async () => {
                const mockAppRegistryClient = mockClient(
                    ServiceCatalogAppRegistryClient
                );
                ...
                mockAppRegistryClient
                    ...
                    .callsFake(({nextToken}) => {
                        if (nextToken != null)
                            return listApplicationsResp[nextToken];
    ...
    describe('configServiceClient', () => {
        ...
        describe('isConfigEnabled', () => {
            it('should return false when recorder is present and delivery channel is not', async () => {
                ...
                mockConfigClient.on(DescribeDeliveryChannelsCommand).resolves({
                    DeliveryChannels: [],
                });
            ...
            it('should return false when delivery channel is present amd recorder is not', async () => {
                ...
                mockConfigClient.on(DescribeDeliveryChannelsCommand).resolves({
                    DeliveryChannels: [{name: 'delivery-channel'}],
                });
                ...
                mockConfigClient
                    ...
                    .callsFake(
                        ({
                            ...
                            const expectedExpression = `SELECT *, configuration, configurationItemStatus, relationships, supplementaryConfiguration, tags WHERE resourceType NOT IN ('AWS::RDS:DbInstance','AWS::EC2::VPC')`;
            ...
            it('should get resources for specific resource types', async () => {
                ...
                mockConfigClient
                    ...
                    .callsFake(({ResourceIdentifiers}) => {
                        return {
                            BaseConfigurationItems: ResourceIdentifiers.map(
                                ({ResourceId}) => {
                ...
                const actual = await getAggregatorResources(
                    'aggregatorName',
                    'AWS::EC2:instance'
                );
        ...
        describe('getConfigAggregator', () => {
            it('should get config aggregator', async () => {
                ...
                const actual = await getConfigAggregator(
                    'configAggregatorName'
                );
    ...
    describe('dynamoDBStreamsClient', () => {
        const {describeStream} = awsClient.createDynamoDBStreamsClient(
            mockCredentials,
            EU_WEST_1
        );
        ...
        describe('describeStream', () => {
            it('should get stream details', async () => {
                const mockDynamoDBStreamsClient = mockClient(
                    DynamoDBStreamsClient
                );

                mockDynamoDBStreamsClient.on(DescribeStreamCommand).resolves({
                    StreamDescription: {
    ...
    describe('ec2Client', () => {
        ...
        describe('getAllRegions', () => {
            it('should get all regions', async () => {
                ...
                mockEc2Client.on(DescribeRegionsCommand).resolves({
                    Regions: [
    ...
    describe('ecsClient', () => {
        const {getAllClusterInstances, getAllClusterTasks, getAllServiceTasks} =
            ...
            it('should get all EC2 instances associated with cluster', async () => {
                ...
                mockEcsClient
                    ...
                    .callsFake(({containerInstances}) => {
                        return {
                            containerInstances: containerInstances.map(
                                arn => instances[arn]
                            ),
                        };
                    });
        ...
        describe('getAllClusterTasks', () => {
            it('should get all tasks running in a cluster', async () => {
                ...
                const taskArns = {
                    cluster: {
                        taskArns: ['taskArn1', 'taskArn2'],
                        nextToken: 'taskToken',
                    },
                    taskToken: {
                        taskArns: ['taskArn3', 'taskArn4'],
                    },
                };

                mockEcsClient.on(ListTasksCommand).callsFake(input => {
                ...
                mockEcsClient.on(DescribeTasksCommand).callsFake(({tasks}) => {
                    return {
    ...
    describe('elbClient', () => {
        const {getLoadBalancerInstances} = awsClient.createElbClient(
            mockCredentials,
            EU_WEST_1
        );
        ...
        describe('getLoadBalancerInstances', () => {
            ...
            it('should get EC2 instances associated with ELB', async () => {
                ...
                assert.deepEqual(actual, ['i-1111111111', 'i-2222222222']);
            });
        });
    });

    describe('elbClient', () => {
        const {describeTargetHealth, getAllTargetGroups} =
            awsClient.createElbV2Client(mockCredentials, EU_WEST_1);

        describe('describeTargetHealth', () => {
            it('should get target health', async () => {
                const mockElbV2Client = mockClient(
                    ElasticLoadBalancingV2Client
                );
    ...
    describe('eksClient', () => {
        const {listNodeGroups} = awsClient.createEksClient(
            mockCredentials,
            EU_WEST_1
        );
        ...
        describe('listNodeGroups', () => {
            it('should list all node groups in cluster', async () => {
                ...
                const nodeGroupsList = {
                    ...
                    'nodegroups-token': {
                        nodegroups: ['nodegroup3', 'nodegroup4'],
                    },
                };
    ...
    describe('appSyncClient', () => {
        describe('listDataSources', () => {
            const {listDataSources} = awsClient.createAppSyncClient(
                mockCredentials,
                EU_WEST_1
            );
        ...
        describe('listResolvers', () => {
            const {listResolvers} = awsClient.createAppSyncClient(
                mockCredentials,
                EU_WEST_1
            );
    ...
    describe('iamClient', () => {
        const {getAllAttachedAwsManagedPolices} = awsClient.createIamClient(
            mockCredentials,
            EU_WEST_1
        );
        ...
        describe('getAllAttachedAwsManagedPolices', () => {
            it('should get all attached polices', async () => {
                ...
                const attachedAwsManagedPolicies = {
                    'AWS-true': {
                        Policies: [{Arn: 'policyArn1'}, {Arn: 'policyArn2'}],
                        Marker: 'policiesMarker',
                    },
                    policiesMarker: {
                        Policies: [{Arn: 'policyArn3'}, {Arn: 'policyArn4'}],
                    },
                };

                mockIamClient.on(ListPoliciesCommand).callsFake(input => {
                    const {OnlyAttached, Scope, Marker} = input;
                    if (Marker != null)
                        return attachedAwsManagedPolicies[Marker];
                    return attachedAwsManagedPolicies[
                        `${Scope}-${OnlyAttached}`
                    ];
                });
    ...
    describe('lambdaClient', () => {
        const {getAllFunctions, listEventSourceMappings} =
    ...
    describe('mediaConnectClient', () => {
        const {getAllFlows} = awsClient.createMediaConnectClient(
            mockCredentials,
            EU_WEST_1
        );
        ...
        describe('getAllFlows', () => {
            it('should get all flows in paginated operation', async () => {
                ...
                const flows = {
                    ...
                    flowNextToken: {
                        Flows: [{FlowArn: 'FlowArn3'}, {FlowArn: 'FlowArn4'}],
                    },
                };
    ...
    describe('openSearchClient', () => {
        const {getAllOpenSearchDomains} = awsClient.createOpenSearchClient(
            mockCredentials,
            EU_WEST_1
        );
        ...
        describe('getAllOpenSearchDomains', () => {
            it('should get OpenSearch domains', async () => {
                ...
                mockOpenSearchClient
                    ...
                    .resolves({
                        DomainNames: Object.keys(domains).map(DomainName => ({
                            DomainName,
                        })),
                    });
                ...
                mockOpenSearchClient
                    ...
                    .callsFake(({DomainNames}) => {
                        return {
                            DomainStatusList: DomainNames.map(
    ...
    describe('organizationsClient', () => {
        const {getAllActiveAccountsFromParent} =
            awsClient.createOrganizationsClient(mockCredentials, EU_WEST_1);
        ...
        describe('getAllActiveAccountsFromParent', () => {
            it('should get all accounts from root OU', async () => {
                ...
                const mockOrganizationsClient = mockClient(
                    OrganizationsClient,
                    {sandbox}
                );

                mockOrganizationsClient.on(ListRootsCommand).resolves({
                    Roots: [
                        {
                            Id: 'r-xxxx',
                        },
            ...
            it('should get all accounts from non-root OU', async () => {
                ...
                const orgUnits = {
                    ...
                    'ou-xxxx-1111111-token': {
                        OrganizationalUnits: [{Id: 'ou-xxxx-4444444'}],
                    },
                    'ou-xxxx-2222222': {
                        OrganizationalUnits: [{Id: 'ou-xxxx-5555555'}],
                    },
                    'ou-xxxx-3333333': {
                        OrganizationalUnits: [],
                    },
                    ...
                    'ou-xxxx-5555555': {
                        OrganizationalUnits: [{Id: 'ou-xxxx-6666666'}],
                    },
                    'ou-xxxx-6666666': {
                        OrganizationalUnits: [],
                    },
                ...
                const orgUnitAccounts = {
                    ...
                    'ou-xxxx-4444444': {
                        Accounts: [{Id: 'iiiiiiiiiiii', Status: 'ACTIVE'}],
                    },
                    'ou-xxxx-5555555': {
                        Accounts: [
                ...
                mockOrganizationsClient
                    ...
                    .callsFake(({ParentId, NextToken}) => {
                        if (NextToken != null)
                            return orgUnitAccounts[NextToken];
                        if (ParentId != null) return orgUnitAccounts[ParentId];
                    });

                const actualP =
                    getAllActiveAccountsFromParent('ou-xxxx-1111111');
    ...
    describe('snsClient', () => {
        const {getAllSubscriptions} = awsClient.createSnsClient(
            mockCredentials,
            EU_WEST_1
        );
        ...
        describe('getAllSubscriptions', () => {
            it('should list all sns subscriptions', async () => {
                ...
                mockSnsClient
                    ...
                    .callsFake(({NextToken}) => {
                        if (NextToken != null)
                            return snsSubscription[NextToken];
    ...
    describe('stsClient', () => {
        const {getCredentials, getCurrentCredentials} =
        ...
        describe('getAllAttachedAwsManagedPolices', () => {
            it('should get credentials for role', async () => {
                ...
                mockStsClient.on(AssumeRoleCommand).callsFake(({RoleArn}) => {
