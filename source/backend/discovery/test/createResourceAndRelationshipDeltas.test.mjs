...
describe('createResourceAndRelationshipDeltas',  () => {
    ...
    describe('resources', () => {
        ...
        it('should calculate sdk discovered resource updates and ignore unchanged resources', async () => {
            const {default: {dbResources, resources}} = await import('./fixtures/createResourceAndRelationshipDeltas/resources/sdkResources.json', {with: {type: 'json' }});
        ...
        it('should calculate resources to store for config discovered resources', async () => {
            const {default: {dbResources, resources}} = await import('./fixtures/createResourceAndRelationshipDeltas/resources/storedResources.json', {with: {type: 'json' }});
        ...
        it('should calculate deleted resources', async () => {
            const {default: {dbResources, resources}} = await import('./fixtures/createResourceAndRelationshipDeltas/resources/deletedResources.json', {with: {type: 'json' }});
        ...
        it('should calculate resources from Config to update', async () => {
            const {default: {dbResources, resources}} = await import('./fixtures/createResourceAndRelationshipDeltas/resources/configUpdated.json', {with: {type: 'json' }});
        ...
        it('should not calculate updates for tags', async () => {
            const {default: {dbResources, resources}} = await import('./fixtures/createResourceAndRelationshipDeltas/resources/tags.json', {with: {type: 'json' }});
    ...
    describe('relationships', () => {
        ...
        it('should calculate stored relationships', async () => {
            const {default: schema} = await import('./fixtures/createResourceAndRelationshipDeltas/relationships/stored.json', {with: {type: 'json' }});
        ...
        it('should calculate cross region relationships', async () => {
            const {default: schema} = await import('./fixtures/createResourceAndRelationshipDeltas/relationships/crossRegion.json', {with: {type: 'json' }});
            const {dbResources, resources} = generate(schema);
        ...
        it('should skip relationships where target has not been discovered', async () => {
            const {default: schema} = await import('./fixtures/createResourceAndRelationshipDeltas/relationships/unknownRelationships.json', {with: {type: 'json' }});
        ...
        it('should handle links to resources that use resourceName', async () => {
            const {default: schema} = await import('./fixtures/createResourceAndRelationshipDeltas/relationships/resourceName.json', {with: {type: 'json' }});
            const {dbResources, resources} = generate(schema);
        ...
        it('should skip relationships that are already present in db', async () => {
            const {default: schema} = await import('./fixtures/createResourceAndRelationshipDeltas/relationships/unchanged.json', {with: {type: 'json' }});
        ...
        it('should handle relationships that have been deleted', async () => {
            const {default: schema} = await import('./fixtures/createResourceAndRelationshipDeltas/relationships/deleted.json', {with: {type: 'json' }});
            const {dbResources, dbRelationships, resources} = generate(schema);
